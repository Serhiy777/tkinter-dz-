...
label1 = Label(text='MI to KM', bg='black', fg='white')
label1.pack(pady=10)

label2 = Label(text='Input MI:', bg='black', fg='white')
...
btn1 = Button(text='MPH \N{RIGHTWARDS BLACK ARROW} KM', bg='black',fg='white', command=mph_to_km)
btn1.place(x=293,y=80)
btn2 = Button(text='KM \N{RIGHTWARDS BLACK ARROW} MPH', bg='black',fg='white', command=km_to_mph)
